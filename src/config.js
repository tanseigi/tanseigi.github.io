...
module.exports = {
    github: {
        username: 'mightbebot', // Your GitHub org/user name. (Required)
        sortBy: 'stars', // stars | updated
        limit: 8, // How many projects to display.
        exclude: {
            forks: false, // Forked projects will not be displayed if set to true.
            projects: ['PersonalWebsite','tanmay.github.io','machine-learning','ML_Archives','ENGN-4528','Kaggle-Data-Analytics','gatsby-starter-portfolio-cara'] // These projects will not be displayed. example: ['my-project1', 'my-project2']
        }
    },
    social: {
        linkedin: 'mightbebot',
